...
public class Update_preparedSt_Example{
    public static void main(String[] args) {
        ...
        try {
            ...
            String sql = "update classicmodels.employees set firstName=? , lastName=? where employeeNumber = ?";
            ...
            prepStmt = con.prepareStatement("select * from classicmodels.employees where employeeNumber=?");
